...
const newsFeed = ()=>{
  ...
  `;
    const newsList = newsFeed.map(({ id, title, user, points, time_ago, comments_count }, idx)=>{
...
const newsDetail = ()=>{
  ...
  `;
    ...
    rootContainer.innerHTML = template.replace("{{__comments__}}", displayComment(newsContent.comments));
};
const router = ()=>{
